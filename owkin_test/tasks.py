...
def analyse_dockerfile(dockerfile_content):
    ...
    trivy = client.containers.run("aquasec/trivy", f"{image_id}", volumes={TRIVY_CACHE: {'bind': '/root/.cache/', 'mode': 'rw'},})
    ...
    with TemporaryDirectory() as data_dir:
        client.containers.run(image_id, volumes={data_dir.name: {"bind": "/data", 'mode': 'rw'},}, network_disabled=True)
